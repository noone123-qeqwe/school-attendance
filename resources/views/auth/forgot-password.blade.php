...
<div class="otp-wrapper">
    <div class="otp-card">
            ...
            <div class="text-center mb-4">
                ...
                <p class="reset-subtitle">Enter your email address and we'll send you a reset code.</p>
            </div>
        ...
        <form method="POST" action="{{ route('otp.forgot.send') }}">
            ...
            <div style="margin-bottom:20px;">
                ...
                <input type="email" name="email" id="email" class="field-input" placeholder="Enter your email address" value="{{ old('email', old('identifier')) }}" required autocomplete="email" autofocus>
                @if($errors->has('email'))
                <p style="color:#f8c6c6;font-size:.82rem;margin-top:6px;">{{ $errors->first('email') }}</p>
                @elseif($errors->has('identifier'))
