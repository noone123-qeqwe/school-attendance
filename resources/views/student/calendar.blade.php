...
@media (max-width: 768px) {
    ...
    /* Today cell - Remove cell highlight, keep only number highlight */
    .fc .fc-day-today {
        background: transparent !important;
        box-shadow: none !important;
    }
    ...
    /* Better touch targets for day numbers */
    .fc .fc-daygrid-day-top {
    ...
    .fc .fc-daygrid-more-link {
        ...
        height: 6px !important;
        border-radius: 50% !important;
        background: var(--ent-text-muted) !important;
        padding: 0 !important;
        margin: 0 !important;
    ...
    calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function(info) {
            ...
            if (props.type !== 'holiday' && !info.event.allDay) {
                timeStr += ` Ã¢â‚¬Â¢ ${start.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}`;
                if (end) {
                        ...
                        let html = `
                            <div class="subject-card" style="border: 1px dashed ${event.backgroundColor};">
                                ...
                                <div class="subject-card-info">
                                    ...
                                    <div class="subject-card-teacher" style="text-transform: capitalize;">${props.type.replace('_', ' ')}</div>
                                </div>
                            </div>
                        `;
                        contentContainer.insertAdjacentHTML('beforeend', html);
