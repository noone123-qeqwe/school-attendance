        ...
        <div style="background:white;border:1px solid #e2e8f0;border-radius:12px;padding:24px;box-shadow:0 4px 6px -1px rgba(0,0,0,0.1);">
                ...
                <table style="width:100%;border-collapse:collapse;font-size:.8rem;">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom:1px solid #f1f5f9;">
                            ...
                            <td style="padding:8px;color:#6b7280;">{{ $record->time_in ? \Carbon\Carbon::parse($record->time_in)->format('h:i A') : '—' }}</td>
                        </tr>
                        @empty
                        <tr>
            ...
            <div style="margin-top:24px;padding-top:16px;border-top:1px solid #e2e8f0;text-align:center;">
                <p style="font-size:.72rem;color:#9ca3af;margin:0;">
                    This document contains {{ $attendanceRecords->count() }} attendance record{{ $attendanceRecords->count() !== 1 ? 's' : '' }} • 
