                    ...
                    <tr data-excuse-id="{{ $excuse->id }}">
                        <td data-label="Student">
                            <div class="student-info">
                                <img src="{{ $excuse->user->profile_image ? asset('storage/'.$excuse->user->profile_image) : asset('images/default-avatar.png') }}" 
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div>
                                ...
                                <div style="display: flex; align-items: center; gap: 8px;">
                                    <img src="${excuse.user.profile_image ? '/storage/' + excuse.user.profile_image : '/images/default-avatar.png'}" 
