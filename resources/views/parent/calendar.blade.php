        ...
        <div class="adm-card glass-card">
            <div class="adm-card-head">
                ...
                <div class="calendar-controls">
                    ...
                    <span id="currentMonth" class="calendar-header">
                        {{ CarbonCarbon::create($year ?? now()->year, $month ?? now()->month)->format('F Y') }}
                    </span>
            ...
            <div style="padding: 0 20px;">
                <div class="legend-container">
                    ...
                    <div class="legend-item"><div class="legend-dot" style="background: transparent; border: 2px dashed #fff;"></div> Excused Absence</div>
                </div>
            </div>
...
<!-- Event Detail Modal (For generic viewing) -->
