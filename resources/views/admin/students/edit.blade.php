            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div style="position: relative;">
                        ...
                        <button type="button" class="eye-btn" onclick="togglePassword('se_pw1', this)" tabindex="-1"><i class="bi bi-eye-slash"></i></button>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div style="position: relative;">
                        ...
                        <button type="button" class="eye-btn" onclick="togglePassword('se_pw2', this)" tabindex="-1"><i class="bi bi-eye-slash"></i></button>
                    </div>
                </div>
