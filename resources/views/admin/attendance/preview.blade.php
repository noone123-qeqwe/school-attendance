        ...
        <div style="background:white;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px -1px rgba(0,0,0,0.1);">
                ...
                <table style="width:100%;border-collapse:collapse;font-size:.8rem;">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom:1px solid #f1f5f9;">
                            ...
                            <td style="padding:8px;color:#6b7280;">{{ $log->time_in ? \Carbon\Carbon::parse($log->time_in)->format('h:i A') : '—' }}</td>
                            <td style="padding:8px;">
                                @if($log->excused)
                                <span style="background:#f0fdf4;color:#16a34a;padding:2px 8px;border-radius:99px;font-size:.7rem;font-weight:600;">✓ Yes</span>
                                @else
            ...
            <div style="margin-top:24px;padding-top:16px;border-top:1px solid #e2e8f0;text-align:center;">
                <p style="font-size:.72rem;color:#9ca3af;margin:0;">
                    This document contains {{ $logs->count() }} attendance record{{ $logs->count() !== 1 ? 's' : '' }} • 
