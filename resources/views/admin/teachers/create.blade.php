            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <div style="position: relative;">
                        ...
                        <button type="button" class="eye-btn" onclick="togglePassword('t_pw1', this, event)" data-toggle-password="t_pw1" aria-controls="t_pw1" aria-label="Show password" title="Show password" aria-pressed="false"><i class="bi bi-eye-slash"></i></button>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div style="position: relative;">
                        ...
                        <button type="button" class="eye-btn" onclick="togglePassword('t_pw2', this, event)" data-toggle-password="t_pw2" aria-controls="t_pw2" aria-label="Show password confirmation" title="Show password confirmation" aria-pressed="false"><i class="bi bi-eye-slash"></i></button>
                    </div>
                </div>
