            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div style="position: relative;">
                        ...
                        <button type="button" class="eye-btn" onclick="togglePassword('te_pw1', this, event)" data-toggle-password="te_pw1" aria-controls="te_pw1" aria-label="Show password" title="Show password" aria-pressed="false"><i class="bi bi-eye-slash"></i></button>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div style="position: relative;">
                        ...
                        <button type="button" class="eye-btn" onclick="togglePassword('te_pw2', this, event)" data-toggle-password="te_pw2" aria-controls="te_pw2" aria-label="Show password confirmation" title="Show password confirmation" aria-pressed="false"><i class="bi bi-eye-slash"></i></button>
                    </div>
                </div>
                <div class="col-12" style="margin-top:16px;">
