...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px; flex-wrap:wrap; gap:16px;">
    ...
    <div style="display:flex; gap:12px;">
        ...
        <a href="{{ route('admin.admins.pdf', request()->query()) }}" class="saas-btn saas-btn-secondary">
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <div style="display:flex; gap:6px; justify-content:flex-end;">
                            <a href="{{ route('admin.Admin.history', $Admin) }}" class="saas-btn saas-btn-secondary" style="padding:4px 8px;" title="History">
                                <i class="bi bi-clock-history"></i>
                            </a>
                            <a href="{{ route('admin.admin.edit', $Admin) }}" class="saas-btn saas-btn-secondary" style="padding:4px 8px;" title="Edit">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <form action="{{ route('admin.admin.destroy', $Admin) }}" method="POST" onsubmit="return confirm('Delete {{ addslashes($Admin->name) }}?')">
                                @csrf @method('DELETE')
...
<div class="modal fade" id="importModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" style="background: #ffffff; border: 1px solid var(--saas-border);">
            <form action="{{ route('admin.admins.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header" style="border-bottom: 1px solid var(--saas-border);">
                    <h5 class="modal-title" style="color: var(--saas-text);"><i class="bi bi-upload me-2 text-primary"></i> Import Admins</h5>
