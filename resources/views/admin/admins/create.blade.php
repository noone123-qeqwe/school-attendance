...
@section('content')
<a href="{{ route('admin.admins') }}" class="adm-btn adm-btn-ghost" style="margin-bottom:20px;text-decoration:none;">
        ...
        <form method="POST" action="{{ route('admin.admin.store') }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-12" style="margin-top:16px;">
                    <button type="submit" class="adm-btn adm-btn-primary"><i class="bi bi-person-plus me-2"></i>Add Admin</button>
                </div>
            </div>
        </form>
    </div>
