                    ...
                    <div style="display:flex;align-items:center;gap:14px;flex:1;min-width:0;">
                        ...
                        <div style="flex:1;min-width:0;">
                            <div class="tlabel" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
                                ...
                                <span class="badge" style="background:rgba(207,164,111,0.15);color:var(--gold,#cfa46f);border:1px solid rgba(207,164,111,0.3);font-size:0.72rem;font-weight:700;flex-shrink:0;">v{{ config('changelog.default_version', '2.3.4') }}</span>
                            </div>
